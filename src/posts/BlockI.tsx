    ...
    <div className="hidden md:block pt-24 pb-12 bg-darkgreen px-[20px] md:px-[120px]">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-12">
        ...
        <div className="col-start-3 col-span-8 flex justify-center items-center relative">
          {/* Card 1 - Left card */}
          <div
            className="w-[450px] h-[450px] bg-lime p-16 rounded-2xl text-center shadow-lg flex flex-col items-center justify-center absolute left-0 -translate-x-10 opacity-70"
            data-aos="fade-up"
          >
          ...
          {/* Card 2 - Center card */}
          <div
            className="w-[450px] h-[550px] bg-lime p-16 rounded-2xl text-center shadow-lg flex flex-col items-center justify-center z-10"
            data-aos="fade-up"
          >
            <h2 className="font-heading text-heading text-darkgreen">
              {heading}
          ...
          {/* Card 3 - Right card */}
          <div
            className="w-[450px] h-[450px] bg-lime p-16 rounded-2xl text-center shadow-lg flex flex-col items-center justify-center absolute right-0 translate-x-10 opacity-70"
            data-aos="fade-up"
          >
            <h2 className="font-heading text-heading text-darkgreen">
              {heading}
